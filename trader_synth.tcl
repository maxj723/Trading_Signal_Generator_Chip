#### Template Script for RTL->Gate-Level Flow (generated from GENUS 20.10-p003_1) 
...
set DESIGN day_trading
set GEN_EFF medium
set MAP_OPT_EFF high
set DATE [clock format [clock seconds] -format "%b%d-%T"] 
set _OUTPUTS_PATH trader_outputs_${DATE}
set _REPORTS_PATH trader_reports_${DATE}
set _LOG_PATH trader_logs_${DATE}
...
read_hdl day_trading.v -language v2001
elaborate $DESIGN
