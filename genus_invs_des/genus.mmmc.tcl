...
create_library_set -name default_emulate_libset_max \
    -timing { /escnfs/courses/fa24-cse-30342.01/dropbox/mjohns79/VLSI/lab5solo/muddlib.lib }

## opcond
create_opcond -name default_emulate_opcond -process 1.0 -voltage 5.0 -temperature 25.0
